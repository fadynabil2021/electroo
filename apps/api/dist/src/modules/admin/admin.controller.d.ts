...
export declare class AdminController {
    ...
    updateOrderStatus(id: string, status: OrderStatus, note: string, req: any): Promise<{
        items: {
            id: string;
            menuItemId: string | null;
            itemNameEn: string;
    ...
    assignRider(id: string, riderId: string, req: any): Promise<{
        items: {
            id: string;
            menuItemId: string | null;
            itemNameEn: string;
    ...
    exportReports(res: import('express').Response): Promise<import("express").Response<any, Record<string, any>>>;
}
